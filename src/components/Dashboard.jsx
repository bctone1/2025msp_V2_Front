...
import { 
  FolderOpen, Activity, MessageSquare,
  ChevronDown, FileText, Code
} from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg border p-6">
            ...
            <div className="text-3xl font-bold">
              {apiKeys.reduce((sum, api) => sum + api.usage.current, 0).toLocaleString()}
            </div>
            <div className="text-sm text-gray-500 mt-1">
              토큰 / {apiKeys.reduce((sum, api) => sum + api.usage.limit, 0).toLocaleString()} 한도
            </div>
          </div>
